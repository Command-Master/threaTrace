...
class TestDataset(InMemoryDataset):
    def __init__(self, data_list, scene):
        super(TestDataset, self).__init__(f'/tmp/TestDataset_{scene}')
...
def MyDataset(output_path, path, model):
    graphId = model
    node_cnt = 0
    nodeType_cnt = 0
    edgeType_cnt = 0
